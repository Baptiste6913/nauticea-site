...
var setNavLeft = (function ($) {
    "use strict";
    return function () {
        $("nav.nav").css("left", $(".sheet").offset().left + "px");
    };
})(jQuery);
jQuery(setNavLeft);
...
resizeData['logo-1179236807'] = {
   responsive: [
                  { left: 0.37, top: 0.37, visible: false }, 
                  { left: 0.37, top: 0.37, visible: false }, 
                  { left: 0.37, top: 0.37, visible: false }, 
...
resizeData['logo-1382603607'] = {
   responsive: [
                  { left: -0.12, top: 0.53, visible: true }, 
                  { left: -0.12, top: 0.53, visible: true }, 
                  { left: -0.12, top: 0.53, visible: true }, 
                  { left: -0.12, top: 0.53, visible: true }, 
                  { left: -0.12, top: 0.53, visible: true }, 
