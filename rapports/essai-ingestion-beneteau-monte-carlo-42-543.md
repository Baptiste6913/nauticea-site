# Mise à jour d'annonce : BENETEAU MONTE CARLO 42

Essai de lecture : aucune annonce ni photo n'a été écrite, seul ce rapport l'a été.

- fiche source : `2010-Beneteau-Monte_Carlo_42.pdf`, 8 pages
...
- spécification « Puissance CV » (370) conservée depuis l'annonce en ligne, la fiche ne la donne pas
...
| marque | BENETEAU |
| modèle | Monte Carlo 42 |
| année | 2010 |
| état | occasion |
| prix | 160000 EUR |
| longueur | 12.82 m |
| largeur | 3.93 m |
| catégorie | bateaux-moteur / vedette |
| emplacement | Fréjus, Var, France |
| statut fiscal | Payé |
| moteurs | 2 |
| équipements | 26 |
| caractères de description | 2272 |

## Moteurs

- moteur 1 : 2010 Volvo D6-370, type Inbord, Diesel, puissance a_confirmer, heures 700, entraînement Stern Drive
- moteur 2 : 2010 Volvo D6-370, type Inbord, Diesel, puissance a_confirmer, heures 700, entraînement Stern Drive
...
- spec « Emplacement » : vide devient Fréjus, Var, France
- spec « Marque moteur » : VOLVO devient Volvo
- spec « Matériau de coque » : vide devient Composite
- spec « Modèle moteur » : vide devient D6-370
- spec « Nombre de moteurs » : vide devient 2
- spec « Statut fiscal » : vide devient Payé
- spec « Toilettes » : vide devient 2
- spec « Type d'entraînement » : vide devient Stern Drive

## Sections d'équipements

- Système électronique : GPS, VHF, Haut-parleurs de cockpit, Pilote automatique, Radar, Radio, Sondeur, TV
- Équipement Intérieur : Air conditionné, WC électrique, Chargeur de batteries, Congélateur, Eau chaude, Micro-onde, Propulseur d'étrave, Réfrigérateur
- Équipement Extérieur/Options : Cockpit teck, Coussins de cockpit, Douche de cockpit, Panneau solaire, Passerelle hydraulique, Table de cockpit, Échelle de bain
- Tauds : Taud de cockpit
- Appareillage Électrique : Générateur, Prise de quai
