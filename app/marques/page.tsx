...
export default function Marques() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      {/* Une carte par marque, photo du bateau en tête de carte
          (demande client du 16/08). Photos issues du slider du site
          d'origine (identification par nom de fichier dans
          corpus-nauticea/raw/accueil.html). */}
      <Reveal className="mt-8 grid gap-6 md:grid-cols-2">
        <Surface as="article" niveau="affleure" className="overflow-hidden rounded-lg border border-encre/10 bg-white">
